          ...
          _createClass(Player, [
            ...
            },
            {
              ...
              value: function deleteVideoElement() {
                ...
                if (this.videoElement) {
                  ...
                  this.objectPlayer.stop();
                  document.body.removeChild(this.objectPlayer);
               ...
               * @param {String} contenttype - content type for video content
               * @param {String} customData - Custom Data
               * @param {Bool} drm - drm boolean for video content
               *
               * @for Player
            ...
            },
            {
              ...
              value: function addVideoSource(src, contenttype, customData, drm) {
                ...
                // if (src.Source.match(/\/manifest/i)) {
              ...
              /**
               * Delete first child source in this video element
               */
            },
            {
              key: 'deleteVideoSource',
              value: function deleteVideoSource() {
                /**
                 * if video element has source element, delete it.
                 */
                try {
                  ...
                  console.log('delete video source error', error.message);
                }
              }
                    ...
                    for (var j = 0; j < creativeLinear.length; j += 1) {
                      ...
                      if (creativeLinearVideoClicks != null) {
                        for (var _k = 0; _k < creativeLinearVideoClicks.length; _k += 1) {
                          var creativeLineartVClicksClickthrough = creativeLinearVideoClicks[_k].getElementsByTagName(
                            'ClickThrough'
                          )[0].childNodes[0].nodeValue;
                          var creativeLineartVClicksClickthroughTracking = creativeLinearVideoClicks[
                            _k
                            ].getElementsByTagName('ClickTracking');
                      ...
                      if (creativeLinearTrackingEvents != null) {
                        for (var _k2 = 0; _k2 < creativeLinearTrackingEvents.length; _k2 += 1) {
                          var creativeLinearTrackingEventsTracking = creativeLinearTrackingEvents[
                            _k2
                ...
                if (typeof mediaFiles !== 'undefined') {
                  for (var _i = 0; _i < mediaFiles.length; _i += 1) {
                    if (mediaFiles[_i].getAttribute('type') === options.media_type) {
                      if (
                        mediaFiles[_i].getAttribute('bitrate') > options.media_bitrate_min &&
                        mediaFiles[_i].getAttribute('bitrate') < options.media_bitrate_max
                      ) {
            ...
            },
            {
              ...
              value: function addAdsCaption() {
                ...
                // Adjust style
                this.captionDiv.style.left =
                  this.vastElement.offsetWidth / 2 -
                  document.getElementsByClassName('vastCaption')[0].offsetWidth / 2 +
                  'px';
            ...
            },
            {
              ...
              value: function addSubtitle(srt, targetElement) {
                ...
                this.Events.addListener('player_onTimeUpdate', function () {
                  if (_this.playerInfo.subtitleEnabled) {
                    return _this.Subtitle.tick();
                  }
                });
                this.Events.addListener('player_onEnded', function () {
                  if (_this.playerInfo.subtitleEnabled) {
                    return (_this.Subtitle.target.innerText = '');
                  }
                });
            ...
            },
            {
              ...
              value: function addTracks(tracks) {
                for (let index = 0; index < tracks.length; index++) {
                  ...
                  track.srclang = tracks[index].code;
                  track.src = tracks[index].src;
                  this.videoElement.appendChild(track);
                }
              }
              /**
               * Enable subtitle track for Player
               * @for Player
               */
            },
            {
              ...
              value: function enableTrack(track) {
                if (this.videoElement.textTracks) {
                  for (let index = 0; index < this.videoElement.textTracks.length; index++) {
                    console.log(this.videoElement.textTracks[index].language, track);
                    if (this.videoElement.textTracks[index].language === track) {
                      this.videoElement.textTracks[index].mode = 'showing';
                    } else {
                      this.videoElement.textTracks[index].mode = 'disabled';
                    }
                  }
                }
              }
              ...
              value: function tizenRegisterEvents() {
                ...
                var listener = {
                  ...
                  onbufferingcomplete: function () {
                    ...
                    _this.Events.triggerEvent('player_onDurationChange', [Math.trunc(webapis.avplay.getDuration())]);
                    _this.playerInfo.duration = Math.trunc(webapis.avplay.getDuration() / 1000);
                    if (_this.playerInfo.subtitleEnabled) {
                      _this.Subtitle.target.innerText = '';
                      _this.Subtitle.setCurrentSubtitle();
                    }
                    if (
                  ...
                  onstreamcompleted: function () {
                    console.log('Stream Completed autoLoop: ', _this.autoLoop);
                    _this.playerInfo.currentState = 'Finished';
                    _this.Events.triggerEvent('player_onEnded', ['Video Finished']);
                    if (
                      webapis.avplay.getState() != 'IDLE' &&
                      webapis.avplay.getState() != 'NONE' &&
                      (webapis.avplay.getState() == 'PLAYING' || webapis.avplay.getState() == 'READY') &&
                      _this.autoLoop == true
                    ) {
                  ...
                  oncurrentplaytime: function (currentTime) {
                    _this.Events.triggerEvent('player_onTimeUpdate', [Math.trunc(currentTime)]);
                  ...
                  onerror: function (eventType) {
                    ...
                    _this.Events.triggerEvent('player_onError', [eventType]);
                    _this.playerInfo.currentState = 'Error';
                  },
            ...
            },
            {
              ...
              value: function objectVideoEvents() {
                ...
                // 5 finished
                // 6 error
                var pr = ['data', 'type', 'playPosition', 'playTime', 'playState', 'error', 'speed'];
                var ps;
                if (!this.objectInterval) {
                  this.objectPlayer.onPlayStateChange = function (event) {
                    ps = _this.objectPlayer.playState;
                    console.log('event -> ' + playStates[ps] + ' -> ' + ps);
                    switch (ps) {
                      case 0:
                        _this.playerInfo.currentState = 'Stopped';
                        _this.Events.triggerEvent('player_onEnded', ['Video Stopped']);
                        break;

                      case 1:
                        // get duration
                        _this.Events.triggerEvent('player_onDurationChange', [Math.trunc(_this.objectPlayer.playTime)]);
                        _this.playerInfo.duration = Math.trunc(_this.objectPlayer.playTime / 1000);
                        _this.Events.triggerEvent('player_onPlay', ['Play']);
                        _this.playerInfo.currentState = 'Play';
                        break;
                      ...
                      case 5:
                        _this.playerInfo.currentState = 'Finished';
                        _this.Events.triggerEvent('player_onEnded', ['Video Finished']);
                        if (_this.autoLoop && ps != 0) {
                          _this.objectPlayer.play(1);
                        }
                        break;

                      case 6:
                        var error = '';
                        switch (_this.objectPlayer.error) {
                          case 0:
                        ...
                        _this.Events.triggerEvent('player_onError', [error]);
                        _this.playerInfo.currentState = 'Error';
                        break;
                  ...
                  this.objectInterval = setInterval(function () {
                    if (_this.objectPlayer.playState == 1) {
                      // trigger current time
                      _this.Events.triggerEvent('player_onTimeUpdate', [Math.trunc(_this.objectPlayer.playPosition)]);
                    }
                  }, 500);
                }
              }
            ...
            },
            {
              ...
              value: function registerVideoEvents() {
                ...
                //   var errorMessage = JSON.stringify(_this.videoElement.error);

                // 	if (_this.videoElement.error && _this.videoElement.error.code) {
                // 		switch (_this.videoElement.error.code) {
                ...
                //   _this.Events.triggerEvent("player_onError", [errorMessage]);
                //   _this.playerInfo.currentState = "Error";
                // };

                // addeventlistener for video element
                ...
                // addeventlistener for video element end
              }
              ...
              value: function createOIPFDrmAgent() {
                ...
                this.OIPFDrmObject.onDRMMessageResult = function (msgId, resultMsg, resultCode) {
                  ...
                  if (resultCode === 0) {
                    ...
                    switch (resultCode) {
                      case 1:
                        console.warn('Error Code : 1 / Unknown Error - ' + resultMsg);
                        break;
                      case 2:
        ...
        var Subtitle = (function () {
          ...
          _createClass(Subtitle, [
            ...
            },
            {
              ...
              value: function setCurrentSubtitle() {
                ...
                for (var i = 0; i < this.subs.length; i++) {
                  ...
                  } else if ('arSmartTV' in window) {
                    ct = this.Player.objectPlayer.playPosition;
                  } else {
                    ct = this.Player.videoElement.currentTime * 1000;
                  }

                  if (_this.subs[i].startTime > Math.trunc(ct)) {
                    _this.currentSubIndex = i;
                    _this.currentSub = _this.subs[i];
                    break;
                  }
                }
              }
            ...
            },
            {
              ...
              value: function tick() {
                if (
                  this.Player.playerInfo.subtitleEnabled &&
                  (this.Player.playerInfo.currentState == 'Playing' || this.Player.playerInfo.currentState == 'Play')
                ) {
                  if (typeof this.currentSub != 'undefined') {
                    ...
                    if (Math.trunc(cts) > this.currentSub.startTime && Math.trunc(cts) < this.currentSub.endTime) {
                      ...
                      // _logger2.default.addLog("Subtitle  TEXT", "info", "EMPTY SUB");
                    }
                  }
                }
              }
      ...
      /***/ function (module, exports) {
        ...
        var Vast = {
          parseVMAP: function parseVMAP(xml, Events) {
            ...
            var node = void 0;
            if (
              !((xml != null ? xml.documentElement : undefined) != null && xml.documentElement.localName === 'VMAP')
            ) {
	      ...
	      eslint class-methods-use-this: ["error", { "exceptMethods": ["flattenListeners"] }] */
            ...
            },
            {
              ...
              value: function addListener(evt, listener) {
                ...
                var listenerIsWrapped =
                  (typeof listener === 'undefined' ? 'undefined' : _typeof(listener)) === 'object';
                var key = void 0;
            ...
            },
            {
              ...
              value: function manipulateListeners(remove, evt, listeners) {
                ...
                if (
                  (typeof evt === 'undefined' ? 'undefined' : _typeof(evt)) === 'object' &&
                  !(evt instanceof RegExp)
                ) {
                  for (i in evt) {
                    value = evt[i];
	 ...
	 */
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        (function (process) {
          ...
          var btoa =
            (typeof window !== 'undefined' && window.btoa && window.btoa.bind(window)) || __webpack_require__(27);
      ...
      /***/ function (module, exports) {
        ...
        var GAnalytics = (function () {
          function GAnalytics() {
            ...
            this.UID = window.localStorage
              ? (window.localStorage[this.KEY] = window.localStorage[this.KEY] || Math.random() + '.' + Math.random())
              : '';
          }
        ...
        var DeviceArcelik = (function (_Device) {
          ...
          function DeviceArcelik(config) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (DeviceArcelik.__proto__ || Object.getPrototypeOf(DeviceArcelik)).call(this)
            );
          ...
          _createClass(DeviceArcelik, [
            {
              ...
              value: function createVideoElement() {
                ...
                // if (!this.arcelikPlugin) {
                //   this.arcelikPlugin = document.createElement("object");
                //   this.arcelikPlugin.setAttribute("id", "arcelikWebPlugin");
                //   this.arcelikPlugin.setAttribute("type", "application/x-ctvwebplugin");
                //   this.arcelikPlugin.setAttribute("width", "0px");
                //   this.arcelikPlugin.setAttribute("height", "0px");
                //   this.arcelikPlugin.style.visibility = "hidden";
                //   this.arcelikPlugin.style.padding = "0px";
                //   this.arcelikPlugin.style.margin = "0px";
                //   this.arcelikPlugin.style.position = "absolute";
                //   this.arcelikPlugin.style.left = "0px";
                //   this.arcelikPlugin.style.top = "0px";
                //   document.documentElement.insertBefore(this.arcelikPlugin, document.head);
                //   _logger2.default.addLog("Player", "info", "Arcelik Plugin Created");
                // }
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var DeviceLG = (function (_Device) {
          ...
          function DeviceLG() {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (DeviceLG.__proto__ || Object.getPrototypeOf(DeviceLG)).call(this)
            );
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var DevicePhilips = (function (_Device) {
          ...
          function DevicePhilips(config) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (DevicePhilips.__proto__ || Object.getPrototypeOf(DevicePhilips)).call(this)
            );
          ...
          _createClass(DevicePhilips, [
            {
              ...
              value: function createVideoElement() {
                ...
                this.registerVideoEvents();
                _logger2.default.addLog('Player', 'info', 'Philips Player Element Created and Registered Video Events');
                this.initAudioClass();
                return null;
              }
            }
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var DeviceSamsung = (function (_Device) {
          ...
          function DeviceSamsung() {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (DeviceSamsung.__proto__ || Object.getPrototypeOf(DeviceSamsung)).call(this)
            );
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var DeviceTizen = (function (_Device) {
          ...
          function DeviceTizen(config) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (DeviceTizen.__proto__ || Object.getPrototypeOf(DeviceTizen)).call(this)
            );
          ...
          _createClass(DeviceTizen, [
            {
              ...
              value: function addTizenLib() {
                var _scriptfile = document.createElement('script');
                _scriptfile.src = '$WEBAPIS/webapis/webapis.js';
                document.head.appendChild(_scriptfile);
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var DeviceVestel = (function (_Device) {
          ...
          function DeviceVestel(config) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (DeviceVestel.__proto__ || Object.getPrototypeOf(DeviceVestel)).call(this)
            );
          ...
          _createClass(DeviceVestel, [
            {
              ...
              value: function createVideoElement() {
                ...
                this.setPlayerInfo('playready', 'OIPF');
                this.registerVideoEvents();
                _logger2.default.addLog('Player', 'info', 'Vestel Player Element Created and Registered Video Events');
                return null;
              }
            }
          ]);
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var DeviceWeb = (function (_Device) {
          ...
          function DeviceWeb(config) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (DeviceWeb.__proto__ || Object.getPrototypeOf(DeviceWeb)).call(this)
            );
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var DeviceWebOs = (function (_Device) {
          ...
          function DeviceWebOs(config) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (DeviceWebOs.__proto__ || Object.getPrototypeOf(DeviceWebOs)).call(this)
            );
          ...
          _createClass(DeviceWebOs, [
            {
              ...
              value: function addWebOSLib() {
                ...
                // var webosScript = document.createElement("script");
                // webosScript.src = "assets/scripts/device/webos/webOS.js";
                // document.head.appendChild(webosScript);
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var DeviceSeraphic = (function (_Device) {
          ...
          /**
           * This is extendable class for Seraphic group devices
           *
          ...
          function DeviceSeraphic(config) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (DeviceSeraphic.__proto__ || Object.getPrototypeOf(DeviceSeraphic)).call(this)
            );
          ...
          _createClass(DeviceSeraphic, [
            {
              ...
              value: function createVideoElement() {
                ...
                // this.videoElement.setAttribute("width", this.Config.width);
                // this.videoElement.setAttribute("height", this.Config.height);
                // this.videoElement.setAttribute("type", "video/mpeg4");
                // this.videoElement.setAttribute("data", "");
                // this.videoElement.setAttribute("id", "sraf_html5");
                // this.videoElement.setAttribute("class", "player");
                // this.videoElement.setAttribute("crossorigin", "anonymous");
                // document.body.appendChild(this.videoElement);
                // this.registerVideoEvents();
                ...
                _logger2.default.addLog(
                  "Player",
                  "info",
                  "Seraphic Player Element Created and Registered Video Events"
                );
                return null;
              }
            }
